  ...
  return (
    <div className={cx('chart__container')}>
      <div className={cx('selected')}>
        <Radio.Group defaultValue="JEONSE" buttonStyle="solid" onChange={change}>
          <Radio.Button className={cx('button', { checked: type === MAEMAE })} value="MAEMAE">
            매매
          </Radio.Button>
          <Radio.Button className={cx('button', { checked: type === JEONSE })} value="JEONSE">
            전세
          </Radio.Button>
          <Radio.Button className={cx('button', { checked: type === WOLSE })} value="WOLSE">
            월세
          </Radio.Button>
        </Radio.Group>
      </div>
