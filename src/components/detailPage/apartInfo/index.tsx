      ...
      <div className={cx('info__top')}>
        ...
        <div className={cx('top__middle')}>
          <div className={cx('middle__content')}>
            ...
            <span className={cx('content__value')}>{houseInfo.totalApartment}세대</span>
          </div>
          <div className={cx('middle__content')}>
            <span className={cx('content__name')}>분양세대수</span>
            <span className={cx('content__value')}>{houseInfo.bunyangApartment}세대</span>
          </div>
          <div className={cx('middle__content')}>
          ...
          <div className={cx('middle__content')}>
            ...
            <span className={cx('content__value')}>총 {houseInfo.totalDong}개동</span>
          </div>
        </div>
        <div className={cx('top__right')}>
          <button className={cx('button')}>찜하기</button>
          <button className={cx('button')}>공유</button>
        </div>
      </div>
      <div className={cx('info__middle')}>
        <div className={cx('middle__content')}>
          <span className={cx('content__name')}>• 건물 번호</span>
          <span className={cx('content__value')}>{houseInfo.buildingNumber}</span>
        </div>
        <div className={cx('middle__content')}>
      ...
      <div className={cx('info__bottom')}>
        ...
        <div className={cx('bottom__right')}>
          ...
          <div className={cx('section__bottom')}>
            ...
            <div className={cx('apartInfo4_right')}>
              <div className={cx('bg__img')}>
                <div className={cx('bg__text')}>
                  <img className={cx('more__btn')} />
                  <p className={cx('more__text')}>사진 더보기</p>
                </div>
              </div>
            </div>
          </div>
